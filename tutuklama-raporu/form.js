...
window.REPORT_FORM = {
  ...
  "autoText": [
    ...
    {
      "target": "MATERYAL_ANLATI_9F2QX1",
      "alwaysLive": true,
      "build": function (v) { return v.KANIT_TESLIM === 'Evet' ? tutuklamaMaterialLine(v) : ''; }
    }
  ],
  "sections": [
    {
    ...
    },
    {
      ...
      "sharedFieldsAfter": [
        {
          "key": "MATERYAL_ANLATI_9F2QX1",
          "label": "El Koyulan Materyal Anlatısı",
          "type": "textarea",
          "rows": 4,
          "span": "all",
          "copyable": true,
